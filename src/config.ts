export default {
  ...
  Subtitle: '专注于分享精品软件',
  // 网站描述
  Description: '愚人blog，专注于分享超多超好用的精品手机、电脑软件',
  // 网站作者
  Author: '愚人',
  // 作者头像
  Avatar: 'https://jianhancloud.cn/YGPTDR/Image_1762780303107.webp',
  // 网站座右铭
  Motto: '仰天大笑出门去，我辈岂是蓬蒿人',
  // Cover 网站缩略图
  Cover: '/assets/images/banner/suoluetu.webp',
  // 网站侧边栏公告 (不填写即不开启)
  Tips: '<p>欢迎光临我的博客 🎉</p><p>这里会分享我觉得很好用的软件和资源，希望能对你有所帮助:) 💖</p>',
  // 首页打字机文案列表
  TypeWriteList: [
    '不曾与你分享的时间,我在进步.',
